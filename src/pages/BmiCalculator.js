...
const BmiCalculator = () => {    
  ...
  return (
    ...
    <Stack p="80px" gap="30px" backgroundColor="#FFF" width="90%" margin="auto" mt="-10px" >
        ...
        <Button variant="contained" sx={{ bgcolor: '#FF2625'}} color="primary" onClick={fetchBMICalData} disabled={loading}>Calculate BMI</Button>                
    </Stack>
    {BMI==="Not Calcualted" ? '' :
